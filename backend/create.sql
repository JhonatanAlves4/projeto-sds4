create table tb_sales (id int8 generated by default as identity, amount float8, date date, deals int4 not null, visited int4 not null, seller_id int8, primary key (id));
